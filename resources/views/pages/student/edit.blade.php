                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="mng-add_quiz">
                                                                        <form id="update_student_form" class="p-3">
                                                                            @csrf
                                                                            ...
                                                                            <div class="mb-3">
                                                                                <label class="form-label">Class Teacher
                                                                                    Name</label>
                                                                                <select id="class_teacher_id"
                                                                                    ...
                                                                                    @foreach ($teacher as $data)
                                                                                        <option
                                                                                            value="{{ $data->id }}"{{ $student->class_teacher_id == $data->id ? 'selected' : '' }}>
                                                                                            {{ $data->teacher_name }}
                                                                                        </option>
                                                                                    @endforeach
                                                                                </select>
                                                                            ...
                                                                            <div class="q_quiz mb-3">
                                                                                <label class="form-label">Yearly
                                                                                    Fees</label>
                                                                                <input type="text" name="yearly_fees" maxlength="9"
